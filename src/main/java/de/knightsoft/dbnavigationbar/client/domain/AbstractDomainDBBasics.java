...
/**
 *
 * The <code>AbstractDomainDBBasics</code> class is a exchange structure between the client and the servlet on the server with
 * database functions. This is a abstract basic class to setup on.
 *
