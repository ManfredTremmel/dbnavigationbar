 ...
 * @version $Rev$, $Date$
 */
public abstract class AbstractDomainHeadPosDB extends AbstractDomainDBBasics
    implements DomainHeadDataBaseInterface, DomainHeadPosDataBaseInt, Serializable
{
