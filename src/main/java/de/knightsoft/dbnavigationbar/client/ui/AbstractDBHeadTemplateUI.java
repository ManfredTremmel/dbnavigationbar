 ...
 * @version $Rev$, $Date$
 */
public abstract class AbstractDBHeadTemplateUI<E extends AbstractDomainHeadDB>
   ...
   */
  public AbstractDBHeadTemplateUI(final Widget[] pThisWidgetlist,
      final String pUserdefinedfunction) {

    super(pThisWidgetlist, pUserdefinedfunction);
  }
}
