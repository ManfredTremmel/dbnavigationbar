 ...
 * @version $Rev$, $Date$
 */
public abstract class AbstractDBHeadPosTemplate<E extends DomainHeadPosDataBaseInt>
   ...
   */
  public AbstractDBHeadPosTemplate(final Class<E> pType, final String pLookUpDataBase,
    ...
    super(pType, pLookUpDataBase, pSessionUser, pDataBaseTableName, pKeyFieldName, pInsertHeadSQL,
        pUpdateHeadSQL, pPosDataBaseTableName, pPosKeyfieldName, pInsertPosSQL, pUpdatePosSQL);
  }
      ...
      try {
        ...
        try (final Connection thisDataBase = lDataSource.getConnection()) {
          ...
          if (this.allowedToChange()) {
            ...
            try (final PreparedStatement invalidatePosSQLStat =
                thisDataBase.prepareStatement(this.getInvalidatePosSQL())) {
              int numPos = 0;
    ...
    try {
      ...
      if (returnEntry != null && returnEntry.getKeyCur() != null) {
        try (final PreparedStatement readPosSQLStatement =
            pThisDataBase.prepareStatement(this.getReadPosSQL())) {
