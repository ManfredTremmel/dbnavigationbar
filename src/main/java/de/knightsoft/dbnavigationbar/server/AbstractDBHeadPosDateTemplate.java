...
public abstract class AbstractDBHeadPosDateTemplate<E extends DomainHeadPosDataBaseInt>
   ...
   */
  public AbstractDBHeadPosDateTemplate(final Class<E> pType, final String pLookUpDataBase,
  ...
  public AbstractDBHeadPosDateTemplate(final Class<E> pType, final String pLookUpDataBase,
    ...
    super(pType, pLookUpDataBase, pSessionUser, pDataBaseTableName, pKeyFieldName, pInsertHeadSQL,
        pPosDataBaseTableName, pPosKeyfieldName, pInsertPosSQL);
  }
  ...
  public AbstractDBHeadPosDateTemplate(final Class<E> pType, final String pLookUpDataBase,
    ...
    super(pType, pLookUpDataBase, pSessionUser, pDataBaseTableName, pKeyFieldName, pInsertHeadSQL,
        pPosDataBaseTableName, pPosKeyfieldName, pInsertPosSQL, pReadHeadSQL, pReadPosSQL);
  }
    ...
    try {
      ...
      if (returnEntry != null && returnEntry.getKeyCur() != null) {
        try (final PreparedStatement readPosSQLStatement =
            pDataBase.prepareStatement(this.getReadPosSQL())) {
