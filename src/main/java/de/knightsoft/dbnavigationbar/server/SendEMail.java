...
public class SendEMail
{
      ...
      final String smtpServer) throws IOException
  {
    ...
    this.sendEMailSendmail(eMailString, smtpServer);
  }
  ...
  public SendEMail(final String from,
      ...
      final String to,
      final String subject,
      final String mailtext) throws IOException
  {
   ...
   *         when sending fails
   */
  public SendEMail(final String eMailString) throws IOException
  {
  ...
  {
    try (final Socket smtpSocket = new Socket(smtpServer, SMTP_PORT))
    {
