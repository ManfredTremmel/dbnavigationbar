    ...
    if (!currentEntry.equals(dbEntry))
    {
      ...
      else
      {
        ...
        if (!currentEntry.equals(dbEntry))
        {
          ...
          // Positions
          try (final PreparedStatement invalidatePosSQLStatement = thisDataBase.prepareStatement(this.getInvalidatePosSQL());
              final PreparedStatement updatePosSQLStatement = thisDataBase.prepareStatement(this.updatePosSQL))
          {
            ...
            for (int i = 0; i < numDbPos; i++)
            {
              ...
              if (isremoved)
              {
                ...
                invalidatePosSQLStatement.setString(sqlPos++, saveKeyString);
